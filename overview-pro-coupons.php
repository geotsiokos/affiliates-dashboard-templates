...
if ( !empty( $affiliates_attributes_coupons ) ) {
	$coupons_exist = true;
	$coupons_output = '<h3>Affiliates Coupons Details</h3>';
	$coupons_output .= '<div class="affiliates-dashboard-overview-coupons">';
	$coupon_codes = explode( ",", $affiliates_attributes_coupons[0]->attr_value );
	foreach( $coupon_codes as $coupon_code ) {
		$coupon = new WC_Coupon( $coupon_code );
		$coupons_output .= '<p>';
		$coupons_output .= '<strong>Code: </strong>';
		$coupons_output .= $coupon_code ;
		$coupons_output .= '<br />';
		if ( $coupon->get_id() == 0 ) {
			$coupons_output .= '<strong>Warning: </strong>This coupon is assigned to an affiliate but it is not valid in the e-Commerce System.';
			$coupons_output .= '<br />';
		} else {
			$coupons_output .= '<strong>Discount: </strong>';
			...
			$coupons_output .= $coupon->get_amount();
			$coupons_output .= $amount_suffix;
			$coupons_output .= '</p>';
		}
	}
	$coupons_output .= '</div>';
