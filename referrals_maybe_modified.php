 ...
 *
 *   mytheme/affiliates/dashboard/referrals_maybe_modified.php
 *
...
<?php
	//
	// Render the referrals_maybe_modified filter form
	//
?>
<div class="dashboard-section dashboard-section-referrals">
	<form id="setfilters" class="filters capsule-container" action="" method="post">
		...
		<div class="capsule full">
			...
			<input class="input-text search-filter" title="<?php echo esc_attr( __( 'Search for a term in referrals_maybe_modified', 'affiliates' ) ); ?>" name="search" type="text" value="<?php echo esc_attr( stripslashes( $section->get_search() ) ); ?>" placeholder="<?php esc_html_e( 'Search for &hellip;', 'affiliates' ); ?>"/>
		</div>
...
<?php
	//
	// Render the referrals_maybe_modified section
	//
?>
...
</div><?php // .referrals_maybe_modified-container ?>
<?php
	//
...
<?php if ( $section->get_count() > 0 ) : ?>
	<div class="section-navigation">
		<?php if ( $section->get_current_page() > 0 ) : ?>
			<a style="margin: 4px;" class="button" href="<?php echo esc_url( $section->get_url( array( 'referrals_maybe_modified-page' => $section->get_current_page() - 1 ) ) ); ?>"><?php echo esc_html_x( 'Previous', 'Label used to show previous page of affiliate referral results', 'affiliates' ); ?></a>
		<?php endif; ?>
		<?php if ( $section->get_current_page() < $section->get_pages() - 1 ) : ?>
			<a style="margin: 4px;" class="button" href="<?php echo esc_url( $section->get_url( array( 'referrals_maybe_modified-page' => $section->get_current_page() + 1 ) ) ); ?>"><?php echo esc_html_x( 'Next', 'Label used to show next page of affiliate referral results', 'affiliates' ); ?></a>
		<?php endif; ?>
	</div>
...
<?php endif; ?>
</div><?php // .dashboard-section-referrals_maybe_modified ?>
<?php
	//
	// Section styles
	//
