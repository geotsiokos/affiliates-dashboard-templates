...
<?php if ( affiliates_user_is_affiliate() ) : ?>
	...
	<div class="dashboard-section dashboard-section-profile">
		<?php echo Affiliates_Shortcodes::affiliates_fields( array( 'edit' => 'no' ) ); ?>
	</div><?php // .dashboard-section-profile ?>
	<script>
		jQuery('input.regular-text.last_name').hide();
		jQuery('input.regular-text.last_name').parent('label').hide();
	</script>
<?php endif; ?>
<style type="text/css">
